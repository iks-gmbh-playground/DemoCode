package com.iksgmbh.demo.hoo.horoscope.dao;
...
public class HoroscopeDAO 
{
	...
	private Horoscope createHoroscopeFromResultSet(ResultSet resultSet) throws SQLException 
	{
		...
		horoscope.setOrderNumber(resultSet.getLong(1));
		horoscope.setHoroscopeType(HoroscopeType.valueOf(resultSet.getString(2)));
		horoscope.setHoroscopeText(resultSet.getString(3).replaceAll("''", "'"));
		horoscope.setInvoiceFactor(resultSet.getBigDecimal(4)); 
