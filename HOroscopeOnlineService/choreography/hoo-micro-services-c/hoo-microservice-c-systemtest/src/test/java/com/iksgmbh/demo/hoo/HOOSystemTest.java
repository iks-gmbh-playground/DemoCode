...
public class HOOSystemTest 
{
	...
	public void createsOverviewOfAllOrders() 
	{
		...
		// act 
    	final String result = jerseyClient.resource("http://" + HOST_PORT + "/HOOServiceOrder/order/all")
	...
	private void setPaidStatus(long orderNumber, boolean paid) 
	{
		...
		jerseyClient.resource("http://" + HOST_PORT + "/HOOServiceOrder/order/status/paid")
	...
	{
    	return jerseyClient.resource("http://" + HOST_PORT + "/HOOServiceHoroscope/horoscope")
                                      .type(MediaType.APPLICATION_XML)
	...
	{
    	return jerseyClient.resource("http://" + HOST_PORT + "/HOOServiceOrder/sendOrder")
                           .type(MediaType.APPLICATION_XML)
                           .accept(MediaType.APPLICATION_XML)
                           .post(HOOOrderResponse.class, request);
	}
