...
import com.iksgmbh.demo.hoo.osgi.HooSystemTestActivator;
...
public class HOOSystemTest 
{
	...
	public void setup() 
	{
		ServiceReference<OrderStore> serviceReference1 = (ServiceReference<OrderStore>) getBundleContext().getServiceReference(OrderStore.class.getName());
		orderStore = (OrderStore) getBundleContext().getService(serviceReference1);
		
		ServiceReference<OrderStore> serviceReference2 = (ServiceReference<OrderStore>) getBundleContext().getServiceReference(OrderStore.class.getName());
		horoscopeStore = (HoroscopeStore) getBundleContext().getService(serviceReference2); 
	}
	...
	private BundleContext getBundleContext() 
	{
		if (bundleContext == null) {
			bundleContext = HooSystemTestActivator.getContext();
		}
