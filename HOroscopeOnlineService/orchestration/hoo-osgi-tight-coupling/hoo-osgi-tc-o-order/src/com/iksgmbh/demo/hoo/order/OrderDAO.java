 ...
 * 
 * Note: This class represents internal implementation and belongs into a non-exported package.
 *       The package com.iksgmbh.demo.hoo.order is made public in the module contract (see manifest.mf),
 *       therefore this DAO is accessible from outside. This should be prevented as in the Horoscope 
 *       and Invoice module!
 * 
...
public class OrderDAO 
{
	...
	{
		final Order order = new Order(resultSet.getLong(1));
