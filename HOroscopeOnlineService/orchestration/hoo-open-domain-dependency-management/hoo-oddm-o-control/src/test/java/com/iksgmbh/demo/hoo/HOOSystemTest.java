...
public class HOOSystemTest {
    ...
    public void createsSuccessfullHOOOrderResponse()
    {
    	...
    	final HOO_OrderRequest request = new HOO_OrderRequestImpl("aCustomer", "JOB", "1.1.1999");
	...
	{
		// arrange
		final HOO_OrderRequest request1 = new HOO_OrderRequestImpl("UnkownCustomer", "JOB", "10.10.1990");
	...
	{
		// arrange
		final HOO_OrderRequest request1 = new HOO_OrderRequestImpl("Prepaid", "JOB", "10.10.1990");
	...
	public void createsOverviewOfAllOrders() {
		...
		final HOO_PaymentRequest request2 = new HOO_PaymentRequest(response1.getOrderNumber(), true);
		sut.setPaidStatus(request2);
		final HOO_OrderRequest request3 = new HOO_OrderRequestImpl("UnkownCustomer", "LOVE", "10.10.1931");
		sut.sendOrder(request3);
		final HOO_OrderRequest request4 = new HOO_OrderRequestImpl("Prepaid", "LOVE", "10.10.1991");
		sut.sendOrder(request4);
		final HOO_OrderRequest request5 = new HOO_OrderRequestImpl("Prepaid", "MISC", "10.10.1991");
