...
public class HOroscopeOnlineService 
{
	...
	OrderStore orderStore = OrderStore.getOrderStore();
	HoroscopeStore horoscopeStore = HoroscopeStore.getHoroscopeStore();
	InvoiceStore invoiceStore = InvoiceStore.getInvoiceStore();
