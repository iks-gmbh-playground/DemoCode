...
public class HOroscopeOnlineService 
{
	...
	private Order takeOrder(HOO_OrderRequest request) {
		return orderStore.createNewInstance(request);
	}
	...
	public static void main(String[] args) 
	{
		...
		final HOO_OrderRequest request1a = new HOO_OrderRequestImpl("UnkownCustomer", "JOB", "10.10.1990");
		...
		final HOO_OrderRequest request2 = new HOO_OrderRequestImpl("UnkownCustomer", "LOVE", "10.10.1931");
		final HOO_OrderResponse response2 = sut.sendOrder(request2);
		sysOutOrder(request2, response2);
		
		final HOO_OrderRequest request3 = new HOO_OrderRequestImpl("Prepaid", "LOVE", "10.10.1991");
		final HOO_OrderResponse response3 = sut.sendOrder(request3);
		sysOutOrder(request3, response3);
		
		final HOO_OrderRequest request4a = new HOO_OrderRequestImpl("Prepaid", "MISC", "10.10.1991");
