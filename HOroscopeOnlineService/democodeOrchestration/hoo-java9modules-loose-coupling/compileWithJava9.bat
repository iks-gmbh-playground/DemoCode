...
echo Compiling Java-9-module hoo.order...
cd hoo-java9modules-o-lc-order
...
echo Compiling Java-9-module hoo.horoscope...
cd hoo-java9modules-o-lc-horoscope
...
echo Compiling Java-9-module hoo.invoice...
cd hoo-java9modules-o-lc-invoice
...
echo Compiling Java-9-module hoo.control...
cd hoo-java9modules-o-lc-control
...
echo Compiling Java-9-module hoo.systemtest...
cd hoo-java9modules-o-lc-systemtest
